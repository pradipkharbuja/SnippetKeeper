...
public class BugReportController {
	...
	public String addBug(@Valid @ModelAttribute("bug")Bug bug,BindingResult bindingResult,RedirectAttributes redirect){
		...
		String rootDirectory = context.getRealPath("/");
			...
			if (bugImage!=null && !bugImage.isEmpty()) {
		       try {
		    	   String fileName = bug.getEmail()+System.currentTimeMillis();
